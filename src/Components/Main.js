...
import file from "./images/Nitin_SWE_Resume_VT.pdf";
  ...
  return (
    <div className="h-auto w-full" id="Home">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-16 items-center">
        ...
        >
          <img
            className="rounded-xl h-96 w-96 sm:max-w-md object-cover shadow-[7px_7px_10px_2px_rgba(0,_0,_0,_0.15)]"
            src={logo}
            alt="Profile"
          />
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 1 }}
        >
          <h2 className="text-3xl font-bold lbtn mt-8 text-t1">
            <span className="text-t1 lbtn ">Hi</span>, I am
          </h2>
          <h1 className="text-4xl sm:text-5xl text-t1 font-serif font-extrabold name lbtn">
            Nitin Tiwari
          </h1>
          <TypeWrite />
          <p className="text-xl text-center mx-auto sm:mx-0 sm:text-left font-medium lbtn w-4/5 text-t2">
            I am a dedicated <span className="text-black">Full-Stack</span>{" "}
            Developer with expertise in React, Node.js, SQL, Tailwind CSS, HTML,
            CSS, and JavaScript. I build intuitive, high-performance web
            applications, leveraging the latest technologies to deliver seamless
            and scalable solutions.
          </p>
          {/*Socials */}
          <motion.div
            className=" grid sm:flex justify-center sm:justify-start space-x-6"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 1 }}
          >
            ...
            <div className="flex justify-center items-center space-x-6">
              <motion.a
                ...
                whileTap={{ scale: 0.8 }}
                href="https://www.instagram.com/nitin_0_o/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 border border-black bg-dc rounded-lg"
              >
                <svg
              ...
              <motion.a
                whileHover={{ scale: 1.2 }}
                whileTap={{ scale: 0.8 }}
                href="https://www.linkedin.com/in/nitin-tiwari-764876205/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 border border-black bg-dc rounded-lg"
              >
              ...
              <motion.a
                whileHover={{ scale: 1.2 }}
                whileTap={{ scale: 0.8 }}
                href="https://leetcode.com/nitin2002/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 border border-black bg-dc rounded-lg"
              >
              ...
              <motion.a
                whileHover={{ scale: 1.2 }}
                whileTap={{ scale: 0.8 }}
                href="https://www.codechef.com/users/matrix_is_real"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 border border-black bg-dc rounded-lg"
              >
            ...
            <motion.div className="flex justify-center sm:justify-end mt-4 sm:mt-0">
              <a href={file} download>
                <motion.button className="resume text-white h-14 w-28 text-lg border-2 border-black bg-t1 rounded-xl flex justify-evenly items-center font-bold hover:transition hover:scale-110">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
