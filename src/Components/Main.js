...
import file from "./images/Nitin.Tiwari.Resume.pdf";
import { motion } from "framer-motion";
import TypeWrite from "./TypeWriter";
import '../App.css'
function Main() {
  return (
    <div className="m-0 p-5 h-auto w-full" id="Home">
      {/* Resume Button */}
      <motion.div
      ...
      >
        <a href={file} download>
          <motion.button
            className="resume text-black h-10 w-32 text-lg border-2 border-black rounded-xl bg-teal-300 flex justify-evenly items-center font-bold hover:bg-gray-500"
            animate={{
              y: [5, -10, 0],
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-8 items-center">
        ...
        >
          <h2 className="text-3xl font-bold">
            <span className="text-teal-300">Hi</span>, I am
          </h2>
          <h1 className="text-4xl sm:text-5xl font-serif font-extrabold name lbtn">
            Nitin Tiwari
          </h1>
          <TypeWrite />
          <p className="text-xl font-medium lbtn">
          I am a dedicated <span className="text-teal-300">Full-Stack</span> Developer with expertise in React, Node.js, SQL, Tailwind CSS, HTML, CSS, and JavaScript. I build intuitive, high-performance web applications, leveraging the latest technologies to deliver seamless and scalable solutions.
          </p>
        </motion.div>
      </div>
      ...
      >
        ...
        <motion.a
          whileHover={{ scale: 1.2 }}
          whileTap={{ scale: 0.8 }}
          href="https://www.linkedin.com/in/nitin-tiwari-75aa7a1b3/"
          target="_blank"
          rel="noopener noreferrer"
          className="p-2 border-2 border-white rounded-lg"
        >
